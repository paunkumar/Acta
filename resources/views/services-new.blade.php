            ...
            <div class="container aos-init aos-animate" data-aos="fade-up">
                <header class="about-header">
                    ...
                    @php
                        ...
                        // Get the text after the slash in the URL path
                        $textAfterSlash = explode('/', $path)[2] ?? null;
                    @endphp
                    <p class="sub-para">{{$textAfterSlash}}</p>
                </header>
            </div>
        </section>
        <section id="about-us">
            ...
            <div id="service-head" class="container">
                <h4> <center>Offshore Staffing for Accounting/CPA firms | Outsourced Bookkeeping & Accounting |<br> VCFO Support | Tax Preparation, Planning & Projection </center>
                </h4><br>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="acta-service-menus">
                            <ul class="nav nav-pills">
                                <li class="active"><a href="{{ url('services/USA/Accounting-Bookkeeping-services/') }}"><img src="{{ url('/assets/img/icon/USA.png') }}" alt="Outsourced Accounting and Bookkeeping Services" class=""/>USA</a></li>
