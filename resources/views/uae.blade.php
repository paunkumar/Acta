                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="services_link">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ url('services/uae/accounting-bookkeeping-services/') }}"><img src="{{ url('/assets/img/icon/UAE.png') }}" alt="" class=""/>UAE</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-11 mx-auto">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                <div class="services_wrap ">
                                    <div class="d-flex align-items-center mb-3">
                                        <div><img src="{{ url('/assets/img/icon/ACTA Value added tax (VAT).png') }}" alt="ACTA Value added tax (VAT)"/></div>
                                        <div class="pl-15"><h3>Value added tax (VAT)</h3></div>
                                    </div>
                                    <p>We have tremendous expertise in doing VAT/Sales Tax 
                                Returns for the past several years.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 mb-5">
                                <div class="services_wrap ">
